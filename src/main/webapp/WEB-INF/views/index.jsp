...
<div class="maxbj1">
    <header>
        <b class="logo"><img src="/images/mylogo.png"></b>
        <search>
            <form>
    ...
    <ul class="slides">
        <li>
            <a title="" target="_blank" href="#">
                <img width="1920" height="500" alt="" style="background: url(/images/banner1.jpg) no-repeat center;"
                     src="/images/alpha.png">
            </a>
        </li>
        <li>
            <a title="" href="#">
                <img width="1920" height="500" alt="" style="background: url(/images/banner2.jpg) no-repeat center;"
                     src="/images/alpha.png">
            </a>
        </li>
        <li>
            <a title="" href="#">
                <img width="1920" height="500" alt="" style="background: url(/images/banner3.jpg) no-repeat center;"
                     src="/images/alpha.png">
            </a>
        </li>
        <li>
            <a title="" href="#">
                <img width="1920" height="500" alt="" style="background: url(/images/banner4.jpg) no-repeat center;"
                     src="/images/alpha.png">
            </a>
        </li>
    </ul>
...
<div class="three_fb">
    <ul>
        <li>
            <light>
                <img src="/images/saoguang1.png">
            </light>
            <a href="liebiao_page.html"><img src="/images/1.jpg"></a>
            <span>价值288元</span>
            <a href="#">查看福包</a>
            <em>200人已购买</em>
        </li>
        <li>
            ...
            <a href="liebiao_page.html"><img src="/images/3.jpg"></a>
            <span>价值288元</span>
            <a href="#">查看福包</a>
            <em>200人已购买</em>
        </li>
        <li>
            ...
            <a href="liebiao_page.html"><img src="/images/2.jpg"></a>
            <span>价值288元</span>
            <a href="#">查看福包</a>
            <em>200人已购买</em>
        </li>
...
<!--应季商品-->
<span class="as blessing_package">
	<a href="#" style=" color:#000"><h3 style="float:left">&nbsp;应季商品<img src="/images/zd.png"
                                                                          style="display:block; float:left; margin-top:5px"></h3></a>
...
<div>
    <div class="currency f-1-lt01">
        <ul>
            <li>
                ...
                <a href="Blessingpackage.html"><img src="/images/56da66aeN557ae881.jpg"
    ...
    <div class="currency f-1-lt02" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/574521dcN025c8825.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-1-lt03" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/571a4db9Neaf4826c.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-1-lt04" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/578c8bedNd80ce7f6.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
...
<!--母婴专区-->
<span class="as blessing_package">
	<a href="#" style=" color:#000"><h3 style="float:left">&nbsp;母婴之家<img src="/images/zd.png"
                                                                          style="display:block; float:left; margin-top:5px"></h3></a>
    <div class="detailed_navigation">
    	<ul>
...
<div>
    <div class="currency f-2-lt01">
        <ul>
            <li>
                <a href="#"><img src="/images/578dc7f8Nfc1dae3b.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-2-lt02" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/56ab1233N47cfb1c0.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-2-lt03" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/572eaa42N2a588fe2.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-2-lt04" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/5608b901N7f95121d.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-2-lt05" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/57830108Nf5015ca6.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-2-lt06" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/57b28416Nd51ed24d.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
...
<!--厨房用品-->
<span class="as blessing_package">
	<a href="#" style=" color:#000"><h3 style="float:left">&nbsp;厨房用品<img src="/images/zd.png"
                                                                          style="display:block; float:left; margin-top:5px"></h3></a>
    <div class="detailed_navigation">
    	<ul>
...
<div>
    <div class="currency f-3-lt01">
        <ul>
            <li>
                <a href="#"><img src="/images/55cd5554N735d3035.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-3-lt02" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/576396a4N0126af00.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-3-lt03" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/55c07298N73ff4204.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-3-lt04" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/53b9fdabNb9255e0c.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-3-lt05" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/57355c74N047d5f4d.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-3-lt06" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/57bfa531Nceb9d696.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
...
<!--生活必备-->
<span class="as blessing_package">
	<a href="#" style=" color:#000"><h3 style="float:left">&nbsp;生活必备<img src="/images/zd.png"
                                                                          style="display:block; float:left; margin-top:5px"></h3></a>
    <div class="detailed_navigation">
    	<ul>
...
<div>
    <div class="currency f-4-lt01">
        <ul>
            <li>
                <a href="#"><img src="/images/57417377N429e10fc.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-4-lt02" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/56f74e97Na5dee145.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-4-lt03" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/56f0d58bN4871ee89.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-4-lt04" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/54c9f2a3N59b95f29.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-4-lt05" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/56892577Nb9cb53be.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-4-lt06" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/rBEIC0_gRMoIAAAAAACg0Wi1QEwAAAykgFTBlIAAKDp775.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-4-lt07" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/57ac4b58N1aa51ca8.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
...
<!--个性筛选-->
<span class="as blessing_package">
	<a href="#" style=" color:#000"><h3 style="float:left">&nbsp;个性筛选<img src="/images/zd.png"
                                                                          style="display:block; float:left; margin-top:5px"></h3></a>
    <div class="detailed_navigation">
    	<ul>
...
<div>
    <div class="currency f-5-lt01">
        <ul>
            <li>
                <a href="#"><img src="/images/578f96e3Ne953ac32.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-5-lt02" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/rBEhU1Kvv8gIAAAAAAcDR5hr6hkAAG4SwPB6yAABwNf577.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-5-lt03" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/5688f53dN144e3333.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-5-lt04" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/56e3bdf0N6b0aa4a7.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
    ...
    <div class="currency f-5-lt05" style="display:none">
        <ul>
            <li>
                <a href="#"><img src="/images/577f624eN2e3465e5.jpg"
                                 style=" margin:0 auto; display:block; width:220px; height:220px"></a>
                <light1>
                    <img src="/images/saoguang.png">
                </light1>
...
<div class="as kongzhianniu">
    <div class="lunbobanner">
        <ul class="lunboimg">
            <li>
                <a href="#">
                    <b><img src="/images/577f624eN2e3465e5.jpg"
                            style=" margin:0 auto; display:block; width:220px; height:220px"></b>
                    <span>￥59</span>
                    <p>罗技 G402 有线光电发光游戏鼠标宏笔记本电脑电竞CF专用LOL </p>
                </a>
                <a href="#">
                    <b><img src="/images/578c8bedNd80ce7f6.jpg"
                            style=" margin:0 auto; display:block; width:220px; height:220px"></b>
                    <span>￥59</span>
                    <p>罗技 G402 有线光电发光游戏鼠标宏笔记本电脑电竞CF专用LOL </p>
                </a>
                <a href="#">
                    <b><img src="/images/578dc7f8Nfc1dae3b.jpg"
                            style=" margin:0 auto; display:block; width:220px; height:220px"></b>
                    <span>￥59</span>
                    <p>罗技 G402 有线光电发光游戏鼠标宏笔记本电脑电竞CF专用LOL </p>
                </a>
                <a href="#">
                    <b><img src="/images/57355c74N047d5f4d.jpg"
                            style=" margin:0 auto; display:block; width:220px; height:220px"></b>
                    <span>￥59</span>
                    <p>罗技 G402 有线光电发光游戏鼠标宏笔记本电脑电竞CF专用LOL </p>
                </a>
                <a href="#">
                    <b><img src="/images/57830108Nf5015ca6.jpg"
                            style=" margin:0 auto; display:block; width:220px; height:220px"></b>
                    <span>￥59</span>
                    <p>罗技 G402 有线光电发光游戏鼠标宏笔记本电脑电竞CF专用LOL </p>
                </a>
            ...
            <li>
                <a href="#">
                    <b><img src="/images/56ab1233N47cfb1c0.jpg"
                            style=" margin:0 auto; display:block; width:220px; height:220px"></b>
                    <span>￥59</span>
                    <p>罗技 G402 有线光电发光游戏鼠标宏笔记本电脑电竞CF专用LOL </p>
                </a>
                <a href="#">
                    <b><img src="/images/572eaa42N2a588fe2.jpg"
                            style=" margin:0 auto; display:block; width:220px; height:220px"></b>
                    <span>￥59</span>
                    <p>罗技 G402 有线光电发光游戏鼠标宏笔记本电脑电竞CF专用LOL </p>
                </a>
                <a href="#">
                    <b><img src="/images/576396a4N0126af00.jpg"
                            style=" margin:0 auto; display:block; width:220px; height:220px"></b>
                    <span>￥59</span>
                    <p>罗技 G402 有线光电发光游戏鼠标宏笔记本电脑电竞CF专用LOL </p>
                </a>
                <a href="#">
                    <b><img src="/images/56892577Nb9cb53be.jpg"
                            style=" margin:0 auto; display:block; width:220px; height:220px"></b>
                    <span>￥59</span>
                    <p>罗技 G402 有线光电发光游戏鼠标宏笔记本电脑电竞CF专用LOL </p>
                </a>
                <a href="#">
                    <b><img src="/images/5688f53dN144e3333.jpg"
                            style=" margin:0 auto; display:block; width:220px; height:220px"></b>
                    <span>￥59</span>
                    <p>罗技 G402 有线光电发光游戏鼠标宏笔记本电脑电竞CF专用LOL </p>
                </a>
...
<footer>
    <section class="foot_in">
        ...
        <div class="foot_in_left">
            ...
            <div>
                <h5>下载APP</h5>
                <img src="/images/ewm.jpg" width="153" height="153" style="display:block">
            </div>
        </div>
        <!--right-->
        <div class="foot_in_right">
            <div>
                <h5>联系我们</h5>
                <p><img src="/images/dian.png" width="40" height="40" style=" float:left"><em
                        style=" float:left; line-height:40px; color:#eb4e01; font-size:20px">&nbsp;&nbsp;&nbsp;6001-666-888</em>
                </p>
                <p><img src="/images/wx.png" width="40" height="40" style=" float:left"><em
